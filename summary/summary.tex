...
The entries $\omega_{ij}$ are so that the conditional distribution of $\Omega$ as a whole can be written as
...
with $C$ a constant that depends on $\delta, v_0^2, v_1^2, \lambda$.
...
Under this continuous spike-and-slab, if an entry $\omega_{ij}$ is truly zero,
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{pictures/sgvsmg.pdf}
  \end{center}
